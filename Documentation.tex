...
\title[Discrete Element Method using LIGGGHTS]{%
  ...
  Discrete Element \par Method \par using LIGGGHTS \par \vspace{1cm} }
...
\label{ch:0}
 \index{acknowledgement}
   ...
   \newthought{A special thanks} to Pedro Dura\'o, Philippe Kikongi, Himmat Dalvi, Francis Lavois, Ounaima  and Cl\'emence Fauteux-Lefebvre for  
