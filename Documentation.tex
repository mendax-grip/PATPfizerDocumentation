...
%----------------------------------------------------------------------------------------
\title[Discrete Element Method using LIGGGHTS]{%
  \setlength{\parindent}{0pt}%
  Discrete Element \par Method using \par  LIGGGHTS \par \vspace{1cm} }
...
\thispagestyle{empty}
\openepigraph{Every duty is holy and devotion to duty is the highest form of worship of God}{Swami Vivekananda}
\vfill
\openepigraph{The greatest prayer is, patience}{Buddha}
\vfill
\openepigraph{I've noticed that even people who believe in fate look both ways before crossing the street.}{Stephen Hawking}
...
\label{ch:0}
 ...
 \newthought{Firstly}, I would like to express my sincere gratitude to my supervisor Prof. Ryan Gosselin for the continuous support, for his patience, motivation, immense knowledge and his contagious energetic approach to problem solving.

 \newthought{My sincere thanks} also goes to Prof. Nicolas Abatzoglou, who provided an opportunity to join their team as an intern and shared valuable insights during my work involving LIGGGHTS. Throughout the internship, he lent tremendous support and encouragement for the work involving simulation and I am grateful for that.  
 ...
 \newthought{A special thanks} to Philippe Kikongi, Himmat Dalvi, Francis B. Lavoie, Oumaima Chaib  and Cl\'emence Fauteux-Lefebvre for stimulating discussions. And Pedro Dur\'ao, with whom I had the pleasure to spend a lot of time during the lab and who provided amazing working practical advices about the world like a zen monk from Portugal.  

 \newthought{ I would also like } to thank all the people I met during the internship, who helped me settle in and feel welcome. I would like to thanks MITACS for funding this research internship  and making all of this possible. 

 \newthought{ Lastly I want } to thanks my parents and two elder sisters, who supported and encouraged me with their best wishes.   
...
\marginnote { This document is stored at \href{https://github.com/mendax-grip/PATPfizerDocumentation}{my Github Repo}}
\index{Github}
...
\nobibliography{bibliography} % Use the bibliography.bib file for the bibliography
